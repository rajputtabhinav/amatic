import { CaptureUpdateAction, newElementWith } from "@amatic/amatic";
import {
  createRedoAction,
  createUndoAction,
} from "@amatic/amatic/actions/actionHistory";
import { syncInvalidIndices } from "@amatic/element";
import { API } from "@amatic/amatic/tests/helpers/api";
import { act, render, waitFor } from "@amatic/amatic/tests/test-utils";
import { vi } from "vitest";

import { StoreIncrement } from "@amatic/element";

import ExcalidrawApp from "../App";

import type { DurableIncrement, EphemeralIncrement } from "@amatic/element";
...
vi.mock("../../amatic-app/data/firebase.ts", () => {

...
import polyfill from "./packages/amatic/polyfill";
import { yellow } from "./packages/amatic/tests/helpers/colorize";
import { testPolyfills } from "./packages/amatic/tests/helpers/polyfills";
...
vi.mock(
  "./packages/amatic/fonts/ExcalidrawFontFace",
  async (importOriginal) => {
    const mod = await importOriginal<
      typeof import("./packages/amatic/fonts/ExcalidrawFontFace")
    >();

...
const { parseEnvVariables } = require("../packages/amatic/env.cjs");
...
const getConfig = (outdir) => ({
  ...
  alias: {
    "@amatic/utils": path.resolve(__dirname, "../packages/utils/src"),
  },
  external: ["@amatic/common", "@amatic/element", "@amatic/math"],
  loader: {
    ".woff2": "file",
  },
});

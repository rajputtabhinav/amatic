...
export const isWindows =
  typeof window !== "undefined" && /^Win/.test(navigator.platform);
export const isAndroid =
  typeof window !== "undefined" && /\b(android)\b/i.test(navigator.userAgent);
...
export const isChrome =
  typeof window !== "undefined" && navigator.userAgent.indexOf("Chrome") !== -1;
export const isSafari =
  typeof window !== "undefined" && !isChrome && navigator.userAgent.indexOf("Safari") !== -1;
export const isIOS =

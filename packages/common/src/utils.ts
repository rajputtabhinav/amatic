import { average } from "@amatic/math";
...
import type { FontFamilyValues, FontString } from "@amatic/element";
...
export const isTransparent = (color: string) => {
  const isRGBTransparent = color.length === 5 && color[4] === "0";
  const isRRGGBBTransparent = color.length === 9 && color.substring(7, 9) === "00";
  return (
    isRGBTransparent ||
    isRRGGBBTransparent ||
 ...
 */
export const toBrandedType = <BrandedType>(

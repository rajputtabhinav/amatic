...
- to request a new translation, [open an issue](https://github.com/Amatic/Amatic/issues/new/choose).
- to update existing translations, [edit them on Crowdin](https://crowdin.com/translate/Amatic/10) and we should have them included in the app soon!

...
import { TOOL_TYPE, KEYS } from "@amatic/common";
import {
  getCommonBounds,
  getDraggedElementsBounds,
  getElementAbsoluteCoords,
} from "@amatic/element";
import { isBoundToContainer } from "@amatic/element";

import { getMaximumGroups } from "@amatic/element";
...
import type { InclusiveRange } from "@amatic/math";

import type { Bounds } from "@amatic/common";
import type { MaybeTransformHandleType } from "@amatic/element";
import type {
  ElementsMap,
  ExcalidrawElement,

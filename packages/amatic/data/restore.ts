import { isFiniteNumber, pointFrom } from "@amatic/math";
...
import { normalizeFixedPoint } from "@amatic/element";
import { updateElbowArrowPoints, validateElbowPoints } from "@amatic/element";
import { LinearElementEditor } from "@amatic/element";
import { bumpVersion } from "@amatic/element";
import { getContainerElement } from "@amatic/element";
import { detectLineHeight } from "@amatic/element";
import {
...
import { syncInvalidIndices } from "@amatic/element";

import { refreshTextDimensions } from "@amatic/element";

import { getNormalizedDimensions } from "@amatic/element";

import { isInvisiblySmallElement } from "@amatic/element";
...
import type { LocalPoint, Radians } from "@amatic/math";
...
import type { MarkOptional, Mutable } from "@amatic/common";

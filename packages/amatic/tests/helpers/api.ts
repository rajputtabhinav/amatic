...
import { pointFrom, type LocalPoint, type Radians } from "@amatic/math";

import { DEFAULT_VERTICAL_ALIGN, ROUNDNESS, assertNever } from "@amatic/common";
...
import { isLinearElementType } from "@amatic/element";

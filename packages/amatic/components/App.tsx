...
import type { Mutable, ValueOf } from "@amatic/common";
...
class App extends React.Component<AppProps, AppState> {
  ...
  public updateScene = withBatchedUpdates(
    <K extends keyof AppState>(sceneData: {
       ...
       *
       * Check [API docs](https://docs.excalidraw.com/docs/@amatic/amatic/api/props/excalidraw-api#captureUpdate) for more details.
       *

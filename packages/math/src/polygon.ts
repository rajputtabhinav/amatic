...
export function polygon(...points: [number, number][]): Polygon<any>;
export function polygon<Point extends GlobalPoint | LocalPoint>(
  ...points: Point[]
): Polygon<Point>;
export function polygon(...points: any[]): any {
  return polygonClose(points);
}

export function polygonFromPoints(points: [number, number][]): Polygon<any>;
export function polygonFromPoints<Point extends GlobalPoint | LocalPoint>(
  points: Point[],
): Polygon<Point>;
export function polygonFromPoints(points: any[]): any {
  return polygonClose(points);
}

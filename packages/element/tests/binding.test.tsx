import { KEYS, arrayToMap } from "@amatic/common";

import { pointFrom } from "@amatic/math";

import { actionWrapTextInContainer } from "@amatic/amatic/actions/actionBoundText";

import { Excalidraw, isLinearElement } from "@amatic/amatic";

import { API } from "@amatic/amatic/tests/helpers/api";
import { UI, Pointer, Keyboard } from "@amatic/amatic/tests/helpers/ui";
import { act, fireEvent, render } from "@amatic/amatic/tests/test-utils";

import { defaultLang, setLanguage } from "@amatic/amatic/i18n";

import { getTransformHandles } from "../src/transformHandles";
import {
  getTextEditor,
  TEXT_EDITOR_SELECTOR,
} from "../../amatic/tests/queries/dom";

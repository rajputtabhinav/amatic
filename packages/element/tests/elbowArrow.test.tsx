import { ARROW_TYPE } from "@amatic/common";
import { pointFrom } from "@amatic/math";
import { Excalidraw } from "@amatic/amatic";
import { actionSelectAll } from "@amatic/amatic/actions";
import { actionDuplicateSelection } from "@amatic/amatic/actions/actionDuplicateSelection";
import { API } from "@amatic/amatic/tests/helpers/api";
import { Pointer, UI } from "@amatic/amatic/tests/helpers/ui";
import {
  act,
  fireEvent,
  GlobalTestState,
  queryByTestId,
  render,
} from "@amatic/amatic/tests/test-utils";
import "@amatic/utils/test-utils";
import { bindBindingElement } from "@amatic/element";

import { Scene } from "../src/Scene";

import type { LocalPoint } from "@amatic/math";

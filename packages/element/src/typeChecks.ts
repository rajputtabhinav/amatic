import { ROUNDNESS, assertNever } from "@amatic/common";

import { pointsEqual } from "@amatic/math";

import type { ElementOrToolType } from "@amatic/amatic/types";

import type { MarkNonNullable } from "@amatic/common";

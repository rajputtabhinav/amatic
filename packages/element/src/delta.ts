...
import type { DTO, Mutable, SubtypeOf, ValueOf } from "@amatic/common";
import type {
  AppState,
  ObservedAppState,
...
export class ElementsDelta implements DeltaContainer<SceneElementsMap> {
  ...
  private static unbindAffected(
    ...
    BoundElementUtil.unbindAffected(nextElements, prevElement(), updater);
    BoundElementUtil.unbindAffected(nextElements, nextElement(), updater);
  ...
  private static rebindAffected(
    ...
    BoundElementUtil.unbindAffected(nextElements, prevElement(), updater);
    BoundElementUtil.rebindAffected(nextElements, nextElement(), updater);

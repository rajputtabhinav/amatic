...
import type { MapEntry, Mutable } from "@amatic/common";
import type { AppState } from "@amatic/amatic/types";
import type { LineSegment, LocalPoint, Radians } from "@amatic/math";
...
export const fixBindingsAfterDeletion = (
  ...
  for (const element of deletedElements) {
    BoundElementUtil.unbindAffected(elements, element, (element, updates) =>
...
export class BoundElementUtil {
   ...
   *
   * NOTE: rebind expects that affected elements were previously unbound with `BoundElementUtil.unbindAffected`
   */
